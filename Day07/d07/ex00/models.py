...
class UserFavouriteArticle(models.Model):
    user: User = models.ForeignKey(User, verbose_name=("UserFavouriteArticle user"), on_delete=models.CASCADE, null=False)
    article: Article = models.ForeignKey(Article, verbose_name=("UserFavouriteArticle article"), on_delete=models.CASCADE, null=False)
